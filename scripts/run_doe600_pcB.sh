#!/bin/bash
# =============================================================================
# PC "B" (Linux) — Multi-DoE OpenRouter, THESIS models, the 10 claims that the
...
#
# Usage (Linux — no caffeinate; keep the box awake with systemd-inhibit):
#   systemd-inhibit --what=idle:sleep --why="LexCausa DoE" bash scripts/run_doe600_pcB.sh
# =============================================================================
set -euo pipefail

PC_LABEL="B"
SHARD_OFFSET=4            # PC B takes global shards 4..7
...
echo "==============================================================="
echo " PC $PC_LABEL (Linux) | global shards ${SHARD_OFFSET}..$((SHARD_OFFSET+WORKERS-1)) of $GLOBAL_SHARDS"
echo "==============================================================="
