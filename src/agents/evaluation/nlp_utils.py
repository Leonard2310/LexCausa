    ...
    def _check_nli_contradiction(
        ...
        try:
            ...
            system_prompt = (
                ...
                "Given two reasoning passages from opposing legal arguments, "
                "classify their logical relationship.\n\n"
                "Choose EXACTLY ONE of these labels:\n"
                "- CONTRADICTION: the two passages reach opposite conclusions "
                "on the same legal question or factual premise.\n"
                "- ENTAILMENT: the two passages support or reinforce each "
                "other, reaching compatible conclusions.\n"
                "- NEUTRAL: the passages address different aspects or their "
